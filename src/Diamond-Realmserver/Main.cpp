...
#ifndef _DIAMOND_REALM_CONFIG
# define _DIAMOND_REALM_CONFIG  "Diamond-Realmserver.conf"
#endif //_DIAMOND_REALM_CONFIG

#ifdef WIN32
#include "ServiceWin32.h"
char serviceName[] = "Diamond-Realmserver";
    ...
    #ifdef WIN32
    {
        ...
        if (Prio)
        {
            if (SetPriorityClass(hProcess,HIGH_PRIORITY_CLASS))
                sLog.outString("Diamond-Realmserver process priority class set to HIGH");
            else
