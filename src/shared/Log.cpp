...
FILE* Log::openGmlogPerAccount(uint32 account)
{
    ...
    char namebuf[DIAMOND_PATH_MAX];
    snprintf(namebuf,DIAMOND_PATH_MAX,m_gmlog_filename_format.c_str(),account);
...
void outstring_log(const char * str, ...)
{
    ...
    Diamond::Singleton<Log>::Instance().outString(buf);
}
...
void detail_log(const char * str, ...)
{
    ...
    Diamond::Singleton<Log>::Instance().outDetail(buf);
}
...
void debug_log(const char * str, ...)
{
    ...
    Diamond::Singleton<Log>::Instance().outDebug(buf);
}
...
void error_log(const char * str, ...)
{
    ...
    Diamond::Singleton<Log>::Instance().outError(buf);
}
...
void error_db_log(const char * str, ...)
{
    ...
    Diamond::Singleton<Log>::Instance().outErrorDb(buf);
}
