...
#ifndef DIAMONDCORE_LOG_H
#define DIAMONDCORE_LOG_H
...
class Log : public Diamond::Singleton<Log, Diamond::ClassLevelLockable<Log, ACE_Thread_Mutex> >
{
    friend class Diamond::OperatorNew<Log>;
    Log();
    ~Log();
...
#ifdef DIAMOND_DEBUG
#define DEBUG_LOG Diamond::Singleton<Log>::Instance().outDebug
#else
#define DEBUG_LOG
#endif
