...
struct boss_kalecgos_kjAI : public ScriptedAI
{
    ...
    void FindOrbs()
    {
        ...
        AllOrbsInGrid check;
        Diamond::GameObjectListSearcher<AllOrbsInGrid> searcher(me, orbList, check);
        TypeContainerVisitor<Diamond::GameObjectListSearcher<AllOrbsInGrid>, GridTypeMapContainer> visitor(searcher);
