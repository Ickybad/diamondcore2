...
Unit* Unit::SelectNearbyTarget(float dist) const
{
    ...
    Diamond::AnyUnfriendlyUnitInObjectRangeCheck u_check(this, this, dist);
    Diamond::UnitListSearcher<Diamond::AnyUnfriendlyUnitInObjectRangeCheck> searcher(this, targets, u_check);
...
bool Unit::SetPosition(float x, float y, float z, float orientation, bool teleport)
{
    ...
    if (!Diamond::IsValidMapCoord(x,y))
    {
