...
void AchievementMgr::SendAchievementEarned(AchievementEntry const* achievement)
{
    ...
    {
        Diamond::AchievementChatBuilder say_builder(*GetPlayer(), CHAT_MSG_GUILD_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED, achievement->ID);
    ...
    else if (GetPlayer()->IsInWorld())
    {
        ...
        Diamond::LocalizedPacketDo<Diamond::AchievementChatBuilder> say_do(say_builder);
        Diamond::PlayerDistWorker<Diamond::LocalizedPacketDo<Diamond::AchievementChatBuilder> > say_worker(GetPlayer(),sWorld.getConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
        TypeContainerVisitor<Diamond::PlayerDistWorker<Diamond::LocalizedPacketDo<Diamond::AchievementChatBuilder> >, WorldTypeMapContainer > message(say_worker);
