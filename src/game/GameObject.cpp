        ...
        case GO_READY:
        {
            ...
            if (isSpawned())
            {
                ...
                if (goInfo->type == GAMEOBJECT_TYPE_TRAP)
                {
                    ...
                    {
                        Diamond::AnyUnfriendlyNoTotemUnitInObjectRangeCheck checker(this, owner, radius);
                        Diamond::UnitSearcher<Diamond::AnyUnfriendlyNoTotemUnitInObjectRangeCheck> searcher(this, ok, checker);
                    ...
                    else                                        // environmental trap
                    {
                        ...
                        // affect only players
                        Player* player = NULL;
                        Diamond::AnyPlayerInObjectRangeCheck checker(this, radius);
                        Diamond::PlayerSearcher<Diamond::AnyPlayerInObjectRangeCheck> searcher(this, player, checker);
...
void GameObject::TriggeringLinkedGameObject(uint32 trapEntry, Unit* target)
{
    ...
    GameObject* trapGO = NULL;
    {
        ...
        Diamond::NearestGameObjectEntryInObjectRangeCheck go_check(*target,trapEntry,range);
        Diamond::GameObjectLastSearcher<Diamond::NearestGameObjectEntryInObjectRangeCheck> checker(this, trapGO,go_check);
...
GameObject* GameObject::LookupFishingHoleAround(float range)
{
    ...
    Cell cell(p);
    cell.data.Part.reserved = ALL_DISTRICT;
    Diamond::NearestGameObjectFishingHole u_check(*this, range);
    Diamond::GameObjectSearcher<Diamond::NearestGameObjectFishingHole> checker(this, ok, u_check);

    TypeContainerVisitor<Diamond::GameObjectSearcher<Diamond::NearestGameObjectFishingHole>, GridTypeMapContainer > grid_object_checker(checker);
