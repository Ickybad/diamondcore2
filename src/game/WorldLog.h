...
#ifndef DIAMOND_WORLDLOG_H
#define DIAMOND_WORLDLOG_H
...
class WorldLog : public Diamond::Singleton<WorldLog, Diamond::ClassLevelLockable<WorldLog, ACE_Thread_Mutex> >
{
    friend class Diamond::OperatorNew<WorldLog>;
    WorldLog();
    WorldLog(const WorldLog &);
    WorldLog& operator=(const WorldLog &);
    typedef Diamond::ClassLevelLockable<WorldLog, ACE_Thread_Mutex>::Lock Guard;
