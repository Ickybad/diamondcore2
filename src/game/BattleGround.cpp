...
namespace Diamond
{
    ...
    class BattleGround2ChatBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr.GetDiamondString(i_textId,loc_idx);
                char const* arg1str = i_arg1 ? sObjectMgr.GetDiamondString(i_arg1,loc_idx) : "";
                char const* arg2str = i_arg2 ? sObjectMgr.GetDiamondString(i_arg2,loc_idx) : "";
...
uint32 BattleGround::GetBonusHonorFromKill(uint32 kills) const
{
    ...
    return Diamond::Honor::hk_honor_at_level(GetMaxLevel(), kills);
}
...
{
    Diamond::BattleGroundChatBuilder bg_builder(type, entry, source);
    Diamond::LocalizedPacketDo<Diamond::BattleGroundChatBuilder> bg_do(bg_builder);
...
void BattleGround::PSendMessageToAll(int32 entry, ChatMsg type, Player const* source, ...)
{
    ...
    Diamond::BattleGroundChatBuilder bg_builder(type, entry, source, &ap);
    Diamond::LocalizedPacketDo<Diamond::BattleGroundChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
...
{
    Diamond::BattleGround2ChatBuilder bg_builder(type, entry, source, arg1, arg2);
    Diamond::LocalizedPacketDo<Diamond::BattleGround2ChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
}
...
//to be removed
const char *BattleGround::GetDiamondString(int32 entry)
{
