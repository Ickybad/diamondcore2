...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
        ...
        cell.SetNoCreate();
        Diamond::NearestAssistCreatureInCreatureRangeCheck u_check(this, getVictim(), radius);
        Diamond::CreatureLastSearcher<Diamond::NearestAssistCreatureInCreatureRangeCheck> searcher(this, pCreature, u_check);

        TypeContainerVisitor<Diamond::CreatureLastSearcher<Diamond::NearestAssistCreatureInCreatureRangeCheck>, GridTypeMapContainer > grid_creature_searcher(searcher);
...
Unit* Creature::SelectNearestTarget(float dist) const
{
    ...
    {
        Diamond::NearestHostileUnitInAttackDistanceCheck u_check(this, dist);
        Diamond::UnitLastSearcher<Diamond::NearestHostileUnitInAttackDistanceCheck> searcher(this, target, u_check);

        TypeContainerVisitor<Diamond::UnitLastSearcher<Diamond::NearestHostileUnitInAttackDistanceCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<Diamond::UnitLastSearcher<Diamond::NearestHostileUnitInAttackDistanceCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
    ...
    if ( !m_AlreadyCallAssistance && getVictim() && !isPet() && !isCharmed())
    {
        ...
        if (radius > 0)
        {
...

            {
                ...
                Diamond::AnyAssistCreatureInRangeCheck u_check(this, getVictim(), radius);
                Diamond::CreatureListSearcher<Diamond::AnyAssistCreatureInRangeCheck> searcher(this, assistList, u_check);

                TypeContainerVisitor<Diamond::CreatureListSearcher<Diamond::AnyAssistCreatureInRangeCheck>, GridTypeMapContainer >  grid_creature_searcher(searcher);
...
void Creature::CallForHelp(float fRadius)
{
    ...
    Diamond::CallOfHelpCreatureInRangeDo u_do(this, getVictim(), fRadius);
    Diamond::CreatureWorker<Diamond::CallOfHelpCreatureInRangeDo> worker(this, u_do);

    TypeContainerVisitor<Diamond::CreatureWorker<Diamond::CallOfHelpCreatureInRangeDo>, GridTypeMapContainer >  grid_creature_searcher(worker);
