...
#ifndef DIAMOND_MAPMANAGER_H
#define DIAMOND_MAPMANAGER_H
...
class MapManager : public Diamond::Singleton<MapManager, Diamond::ClassLevelLockable<MapManager, ACE_Thread_Mutex> >
{
    ...
    public:
        ...
        {
            return IsValidMAP(mapid) && Diamond::IsValidMapCoord(x,y);
        }

        static bool IsValidMapCoord(uint32 mapid, float x,float y,float z)
        {
            return IsValidMAP(mapid) && Diamond::IsValidMapCoord(x,y,z);
        }

        static bool IsValidMapCoord(uint32 mapid, float x,float y,float z,float o)
        {
            return IsValidMAP(mapid) && Diamond::IsValidMapCoord(x,y,z,o);
        }
    ...
    private:
        ...
        typedef Diamond::ClassLevelLockable<MapManager, ACE_Thread_Mutex>::Lock Guard;
