...
bool OPvPCapturePoint::Update(uint32 diff)
{
    ...
    Diamond::AnyPlayerInObjectRangeCheck checker(m_capturePoint, radius);
    Diamond::PlayerListSearcher<Diamond::AnyPlayerInObjectRangeCheck> searcher(m_capturePoint, players, checker);
