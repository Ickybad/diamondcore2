...
#ifndef DIAMONDCORE_CHAT_H
#define DIAMONDCORE_CHAT_H
...
class ChatHandler
{
    public:
        ...
        virtual const char *GetDiamondString(int32 entry) const;
...
//        bool HandleReloadAuctionsCommand(const char* args);
        ...
        bool HandleReloadDiamondStringCommand(const char* args);
...
class CliHandler : public ChatHandler
{
    public:
        ...
        // overwrite functions
        const char *GetDiamondString(int32 entry) const;
