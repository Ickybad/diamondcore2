...
void WorldObject::GetRandomPoint(const Position &pos, float distance, float &rand_x, float &rand_y, float &rand_z) const
{
    ...
    Diamond::NormalizeMapCoord(rand_x);
    Diamond::NormalizeMapCoord(rand_y);
...
{
    return Diamond::IsValidMapCoord(m_positionX,m_positionY,m_positionZ,m_orientation);
}
...
namespace Diamond
{
    class MonsterChatBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr.GetDiamondString(i_textId,loc_idx);
...
void WorldObject::MonsterSay(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    Diamond::PlayerDistWorker<Diamond::LocalizedPacketDo<Diamond::MonsterChatBuilder> > say_worker(this,sWorld.getConfig(CONFIG_LISTEN_RANGE_SAY),say_do);
    TypeContainerVisitor<Diamond::PlayerDistWorker<Diamond::LocalizedPacketDo<Diamond::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterYell(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    Diamond::LocalizedPacketDo<Diamond::MonsterChatBuilder> say_do(say_build);
    Diamond::PlayerDistWorker<Diamond::LocalizedPacketDo<Diamond::MonsterChatBuilder> > say_worker(this,sWorld.getConfig(CONFIG_LISTEN_RANGE_YELL),say_do);
    TypeContainerVisitor<Diamond::PlayerDistWorker<Diamond::LocalizedPacketDo<Diamond::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterTextEmote(int32 textId, uint64 TargetGuid, bool IsBossEmote)
{
    ...
    Diamond::LocalizedPacketDo<Diamond::MonsterChatBuilder> say_do(say_build);
    Diamond::PlayerDistWorker<Diamond::LocalizedPacketDo<Diamond::MonsterChatBuilder> > say_worker(this,sWorld.getConfig(CONFIG_LISTEN_RANGE_TEXTEMOTE),say_do);
    TypeContainerVisitor<Diamond::PlayerDistWorker<Diamond::LocalizedPacketDo<Diamond::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterWhisper(int32 textId, uint64 receiver, bool IsBossWhisper)
{
    ...
    char const* text = sObjectMgr.GetDiamondString(textId,loc_idx);
...
{
    Diamond::MessageDistDeliverer notifier(this, data, GetMap()->GetVisibilityDistance());
    VisitNearbyWorldObject(GetMap()->GetVisibilityDistance(), notifier);
}

void WorldObject::SendMessageToSetInRange(WorldPacket *data, float dist, bool /*bToSelf*/)
{
    Diamond::MessageDistDeliverer notifier(this, data, dist);
...
Creature* WorldObject::FindNearestCreature(uint32 entry, float range, bool alive)
{
    ...
    Diamond::NearestCreatureEntryWithLiveStateInObjectRangeCheck checker(*this, entry, alive, range);
    Diamond::CreatureLastSearcher<Diamond::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(this, creature, checker);
...
{
    GameObject *go = NULL;
    Diamond::NearestGameObjectEntryInObjectRangeCheck checker(*this, entry, range);
    Diamond::GameObjectLastSearcher<Diamond::NearestGameObjectEntryInObjectRangeCheck> searcher(this, go, checker);
...
{
    CellPair pair(Diamond::ComputeCellPair(this->GetPositionX(), this->GetPositionY()));
    Cell cell(pair);
    cell.data.Part.reserved = ALL_DISTRICT;
    cell.SetNoCreate();

    Diamond::AllGameObjectsWithEntryInRange check(this, uiEntry, fMaxSearchRange);
    Diamond::GameObjectListSearcher<Diamond::AllGameObjectsWithEntryInRange> searcher(this, lList, check);
    TypeContainerVisitor<Diamond::GameObjectListSearcher<Diamond::AllGameObjectsWithEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetCreatureListWithEntryInGrid(std::list<Creature*>& lList, uint32 uiEntry, float fMaxSearchRange)
{
    ...
    Diamond::AllCreaturesOfEntryInRange check(this, uiEntry, fMaxSearchRange);
    Diamond::CreatureListSearcher<Diamond::AllCreaturesOfEntryInRange> searcher(this, lList, check);
    TypeContainerVisitor<Diamond::CreatureListSearcher<Diamond::AllCreaturesOfEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetNearPoint2D(float &x, float &y, float distance2d, float absAngle ) const
{
    ...
    Diamond::NormalizeMapCoord(x);
    Diamond::NormalizeMapCoord(y);
}
...
void WorldObject::GetNearPoint(WorldObject const* searcher, float &x, float &y, float &z, float searcher_size, float distance2d, float absAngle ) const
{
    ...
    // adding used positions around object
    {
        ...
        TypeContainerVisitor<Diamond::WorldObjectWorker<Diamond::NearUsedPosDo>, GridTypeMapContainer  > grid_obj_worker(worker);
        TypeContainerVisitor<Diamond::WorldObjectWorker<Diamond::NearUsedPosDo>, WorldTypeMapContainer > world_obj_worker(worker);
...
void WorldObject::MovePosition(Position &pos, float dist, float angle)
{
    ...
    Diamond::NormalizeMapCoord(pos.m_positionX);
    Diamond::NormalizeMapCoord(pos.m_positionY);
